        ...
        <div>
            ...
            <div className={style.WrapperContact}>
                <form onSubmit={e => handleSubmit(e)} className={style.ContactContainer}>
                    ...
                    <div className={style.Input}>
                        <span>Mensaje</span>
                        <textarea type="text" id="message" name="message" value={input.message} placeholder="Deja tu mensaje..." onChange={(e) => handleChange(e)} className={style.MessageInput} />
                ...
                <div className={style.WrapperContactInfo}>
                    <div className={style.WrapperIcons}>
                        ...
                        <div className={style.Block}>
                            <a href="mailto:mountainsdev@gmail.com">
                                <MdOutlineEmail className={style.Icon} />
                                <p>mountaisdevelopment@gmail.com</p>
                            </a>
                        </div>
